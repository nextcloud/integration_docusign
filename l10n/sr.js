OC.L10N.register(
    ...
    "Let users sign files via DocuSign" : "Нека корисници потписују фајлове преко DocuSign",
    "Sign files via DocuSign Service." : "Потписујте фајлове DocuSign сервисом.",
    ...
    "For security reasons, please enter your client credentials again" : "Из разлога безбедности, молимо вас да поново унесете приступне параматре клијента",
    ...
    "DocuSign workflow" : "DocuSign процес рада",
    ...
    "Request signature with DocuSign" : "Захтевај потпис са DocuSign"
},

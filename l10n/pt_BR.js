OC.L10N.register(
    ...
    "Failed to save DocuSign admin options" : "Falha ao salvar as opções de administração do DocuSign",
    ...
    "Client ID (aka integration key)" : "ID de cliente (também conhecido como chave de integração)",
    ...
    "Request a signature via DocuSign" : "Solicitar uma assinatura via DocuSign",
    ...
    "DocuSign workflow" : "Fluxo de trabalho do DocuSign",

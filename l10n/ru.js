OC.L10N.register(
    ...
    "Let users sign files via DocuSign" : "Разрешить пользователям подписывать файлы через DocuSign",
    "Sign files via DocuSign Service." : "Подписывать файлы через сервис DocuSign.",
    ...
    "For security reasons, please enter your client credentials again" : "В целях безопасности введите учетные данные клиента ещё раз",
    ...
    "DocuSign workflow" : "Рабочий процесс DocuSign",
    ...
    "Request signature with DocuSign" : "Запросить подпись с помощью DocuSign"
},

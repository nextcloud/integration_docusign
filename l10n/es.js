OC.L10N.register(
    ...
    "Let users sign files via DocuSign" : "Permita a los usuarios firmar archivos a través de DocuSign",
    "Sign files via DocuSign Service." : "Firmar archivos a través del servicio DocuSign.",
    "Successfully connected to DocuSign!" : "¡Conectado exitosamente a DocuSign!",
    ...
    "Failed to save DocuSign admin options" : "Fallo al guardar las opciones de administración de DocuSign",
    "For security reasons, please enter your client credentials again" : "Por razones de seguridad, por favor, ingrese sus credenciales de cliente nuevamente",
    "Failed to save DocuSign OAuth state" : "Fallo al guardar el estado de DocuSign OAuth",
    ...
    "Secret key of your application" : "Clave secreta de su aplicación",
    ...
    "Failed to request signature with DocuSign" : "Fallo al solicitar la firma con DocuSign",
    ...
    "DocuSign workflow" : "Flujo de trabajo DocuSign",
    "Recipients will receive an email from DocuSign with a link to sign the document. You will be informed by email when the document has been signed by all recipients." : "Los destinatarios recibirán un correo electrónico de DocuSign con un enlace para firmar el documento. Se le informará por correo electrónico cuando el documento haya sido firmado por todos los destinatarios.",
    "Cancel" : "Cancelar",
    ...
    "Request signature with DocuSign" : "Solicitar firma con DocuSign"
},

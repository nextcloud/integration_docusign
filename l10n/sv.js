OC.L10N.register(
    ...
    "Sign files via DocuSign Service." : "Signera filer via DocuSign-tjänsten.",
    "Successfully connected to DocuSign!" : "Anslutningen till DocuSign lyckades!",
    "OAuth access token could not be obtained:" : "Det gick inte att hämta OAuth-åtkomsttoken:",
    "DocuSign admin options saved" : "DocuSigns administratörsinställningar har sparats",
    "Failed to save DocuSign admin options" : "Det gick inte att spara DocuSigns administratörsinställningar",
    "For security reasons, please enter your client credentials again" : "Ange klientuppgifterna igen av säkerhetsskäl",
    "Failed to save DocuSign OAuth state" : "Det gick inte att spara DocuSigns OAuth-tillstånd",
    "DocuSign is an electronic signature solution." : "DocuSign är en elektronisk signaturlösning.",
    "If you want to use DocuSign, create an application in your DocuSign \"My Apps & Keys\" developer account settings and put the client ID (integration key) and secret below." : "För att använda DocuSign skapar du en app under ”My Apps & Keys” i inställningarna för ditt DocuSign-utvecklarkonto och anger klient-ID:t (integreringsnyckeln) och hemligheten nedan.",
    "Make sure you set this \"Redirect URI\":" : "Se till att ange följande ”Redirect URI”:",
    ...
    "Cancel" : "Avbryt",
    "Request signature" : "Begär signatur",
    "Who?" : "Vem?",

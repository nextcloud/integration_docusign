OC.L10N.register(
    ...
    "Let users sign files via DocuSign" : "Benutzer können Dateien über DocuSign signieren",
    "Sign files via DocuSign Service." : "Dateien über den DocuSign-Dienst signieren.",
    ...
    "Failed to save DocuSign admin options" : "DocuSign-Administrationseinstellungen konnten nicht gespeichert werden",
    "For security reasons, please enter your client credentials again" : "Gib bitte aus Sicherheitsgründen deine Anmeldedaten erneut ein",
    "Failed to save DocuSign OAuth state" : "DocuSign OAuth-Status konnte nicht gespeichert werden",
    "DocuSign is an electronic signature solution." : "DocuSign ist eine elektronische Signaturlösung.",
    "If you want to use DocuSign, create an application in your DocuSign \"My Apps & Keys\" developer account settings and put the client ID (integration key) and secret below." : "Wenn du DocuSign verwenden möchtest, erstelle in den Einstellungen deines DocuSign-Entwicklerkontos \"Meine Apps & Schlüssel\" eine Anwendung und gib die Client-ID (Integrationsschlüssel) und das Geheimnis unten ein.",
    ...
    "Failed to request signature with DocuSign" : "Signatur mit DocuSign konnte nicht angefordert werden",
    ...
    "DocuSign workflow" : "DocuSign-Arbeitsablauf",
